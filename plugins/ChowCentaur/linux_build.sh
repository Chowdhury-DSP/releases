...
# cp -R build/ChowMatrix_artefacts/VST/ChowCentaur.so "${name}/usr/lib/vst/"
cp -R build/ChowMatrix_artefacts/VST3/ChowCentaur.vst3 "${name}/usr/lib/vst3/"
cp -R build/ChowMatrix_artefacts/LV2/ChowCentaur.lv2 "${name}/usr/lib/lv2/"
cp -R build/ChowMatrix_artefacts/Standalone/ChowCentaur "${name}/usr/bin/"
