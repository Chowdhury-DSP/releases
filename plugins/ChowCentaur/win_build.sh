...
ASIO_SDK="D:${SDK_PATH:2}/ASIO_SDK/common"
...
sed -i -e "s~.*ASIO_SDK.*~include_directories(${ASIO_PATH})~" CMakeLists.txt
...
cp Installers/windows/"ChowCentaur-Win-$version.exe" ../products/
