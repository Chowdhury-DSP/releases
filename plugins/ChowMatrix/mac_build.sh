...
sed -i -e '16s/#//' ChowCentaur/CMakeLists.txt
...
script_file=installers/mac/ChowMatrix.pkgproj
...
npx notarize-cli --file $pkg_dir/ChowMatrix-signed.pkg \
...
vol_name=ChowMatrix-Mac-$version
