...
cmake --build build --config Release --parallel 4 --target ChowMultiTool_Standalone ChowMultiTool_VST3 ChowMultiTool_CLAP
...
script_file=Installers/windows/ChowMultiTool_Install_Script.iss
sed -i "s/##APPVERSION##/${version}/g" $script_file
iscc $script_file

# create installer (32-bit)
# echo "Creating 32-bit installer..."
# script_file=Installers/windows/ChowMultiTool_Install_Script_32bit.iss
# sed -i "s/##APPVERSION##/${version}/g" $script_file
# iscc $script_file
