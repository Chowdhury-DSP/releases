...
# cp -R build/ChowMatrix_artefacts/VST/CHOWTapeModel.so "${name}/usr/lib/vst/"
cp -R build/ChowMatrix_artefacts/VST3/CHOWTapeModel.vst3 "${name}/usr/lib/vst3/"
cp -R build/ChowMatrix_artefacts/LV2/CHOWTapeModel.lv2 "${name}/usr/lib/lv2/"
cp -R build/ChowMatrix_artefacts/Standalone/CHOWTapeModel "${name}/usr/bin/"
